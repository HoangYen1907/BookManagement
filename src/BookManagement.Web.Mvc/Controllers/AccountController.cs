...
using BookManagement.Sessions;
using BookManagement.Web.Models.Account;
using BookManagement.Web.Views.Shared.Components.TenantChange;

namespace BookManagement.Web.Controllers
{
    public class AccountController : BookManagementControllerBase
    {
